...
public class AddAddressActivity extends SwipeBackActivity {
	// private EditText activity_fragment_address_address;
	private EditText activity_fragment_address_name;
	private EditText activity_fragment_address_phone;
	// private EditText activity_fragment_address_street;
	private Button activity_fragment_address_btn;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		activity_fragment_address_btn.setOnClickListener(new OnClickListener() {

			@Override
			public void onClick(View v) {
				// TODO Auto-generated method stub

				name = activity_fragment_address_name.getText().toString();
				phoneNum = activity_fragment_address_phone.getText().toString();
				jiedao = display.getText().toString();
				address = display.getText().toString();
				if (address.equals("") || name.equals("")
						|| phoneNum.equals("")) {
					Toast.makeText(getApplicationContext(), "确定这样填写吗？亲~~!",
							Toast.LENGTH_SHORT).show();
				} else {
					address2.setAddress(address);
					address2.setName(name);
					address2.setPhone(phoneNum);
					address2.setJiedao(jiedao);
					address2.setCheck(flag);
					new AddressManage().addaddress(address2,
							getApplicationContext());
					Toast.makeText(getApplicationContext(),
							"保存信息成功，小伙伴快去看看购物吧", Toast.LENGTH_SHORT).show();
					finish();
				}
				//
			}
	...
	private void initview() {
		// TODO Auto-generated method stub
		// activity_fragment_address_address = (EditText)
		// findViewById(R.id.activity_fragment_address_address);
		activity_fragment_address_name = (EditText) findViewById(R.id.activity_fragment_address_name);
		activity_fragment_address_phone = (EditText) findViewById(R.id.activity_fragment_address_phone);
		// activity_fragment_address_street = (EditText)
		// findViewById(R.id.activity_fragment_address_street);
		checkBox = (CheckBox) findViewById(R.id.activity_add_address_box);
		activity_fragment_address_btn = (Button) findViewById(R.id.activity_fragment_address_btn);
